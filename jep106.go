...
// extracted from OpenOCD, see src/helper/jep106.inc
func Jep106Manufacturer(bank, id uint32) (string) {
	jep106 := [][]string{
		...
		},
		{
			...
			"Viking Components",
			"V3 Semiconductor",
			"Flextronics (Orbit Semiconductor)",
			"Suwa Electronics",
			"Transmeta",
			"Micron CMS",
		...
		},
		{
			...
			"High Bridge Solutions Industria",
		...
		},
		{
			...
			"Techcomp International (Fastable)",
			"Ancore Technology Corporation",
			"Nuvoton",
			"Korea Uhbele International Group Ltd.",
			...
			"Xiede",
			"Multilaser Components",
			"Flash Chi",
			"Jone",
			"GCT Semiconductor Inc.",
			"Hong Kong Zetta Device Technology",
			"Unimemory Technology(s) Pte Ltd.",
			"Cuso",
			"Kuso",
			"Uniquify Inc.",
			"Skymedi Corporation",
			...
			"Hong Kong Gaia Group Co. Limited",
			"Gigacom Semiconductor LLC",
			"V2 Technologies",
			"TLi",
			"Neotion",
			"Lenovo",
			"Shenzhen Zhongteng Electronic Corp. Ltd.",
			"Compound Photonics",
			"in2H2 inc",
			...
			"Audience Inc.",
			"EpicGear",
			"Vitesse Enterprise Co.",
			"Foxtronn International Corporation",
			"Bretelon Inc.",
			"Graphcore",
			"Eoplex Inc",
			"MaxLinear, Inc.",
			"ETA Devices",
			"LOKI",
			"IMS Electronics Co., Ltd.",
			"Dosilicon Co., Ltd.",
			"Dolphin Integration",
			"Shenzhen Mic Electronics Technology",
			"Boya Microelectronics Inc.",
			"Geniachip (Roche)",
			"Axign",
			"Kingred Electronic Technology Ltd.",
			"Chao Yue Zhuo Computer Business Dept.",
			"Guangzhou Si Nuo Electronic Technology.",
			"Crocus Technology Inc.",
			"Creative Chips GmbH",
			"GE Aviation Systems LLC.",
			"Asgard",
			"Good Wealth Technology Ltd.",
			"TriCor Technologies",
			"Nova-Systems GmbH",
			"JUHOR",
			"Zhuhai Douke Commerce Co. Ltd.",
			"DSL Memory",
			"Anvo-Systems Dresden GmbH",
			"Realtek",
			"AltoBeam",
			"Wave Computing",
			"Beijing TrustNet Technology Co. Ltd.",
			"Innovium, Inc.",
			"Starsway Technology Limited",
		},
		{
			"Weltronics Co. LTD",
			"VMware, Inc.",
			...
			"Paragon Technology (Shenzhen) Ltd.",
			"UMAX Technology",
			"Shenzhen Yong Sheng Technology",
			"SNOAMOO (Shenzhen Kai Zhuo Yue)",
			"Daten Tecnologia LTDA",
			"Shenzhen XinRuiYan Electronics",
			"Eta Compute",
			"Energous",
			"Raspberry Pi Trading Ltd.",
			"Shenzhen Chixingzhe Tech Co. Ltd.",
		},
	}
	if id < 1 || id >= uint32(len(jep106[0])) || bank >= uint32(len(jep106)-1) {
		return "invalid"
	}

	return jep106[bank][id - 1]
}
